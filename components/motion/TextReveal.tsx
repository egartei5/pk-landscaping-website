...
export default function TextReveal({ text, className = '', delay = 0, as: Tag = 'h2', immediate = false }: TextRevealProps) {
      ...
      <span className="flex flex-wrap gap-x-[0.3em] gap-y-1">
        {words.map((word, i) => {
          const animationProps = immediate
            ...
            : { whileInView: { y: 0, opacity: 1 }, viewport: { once: true, margin: '-5%' } }
          return (
