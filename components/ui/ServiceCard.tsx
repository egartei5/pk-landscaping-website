    ...
    <div className="card-dark group flex flex-col h-full overflow-hidden">
      {image && (
        <div className="relative h-44 -mx-6 -mt-6 mb-5 overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-pk-900/60 via-pk-900/10 to-transparent" />
      ...
      <p className="text-gray-300 text-sm leading-relaxed mb-6 flex-1">{shortDescription}</p>
